...
class MyColors {
  static const Color app_main = Color(0xFF161922);
  static const Color app_bg = Color(0xff181824);
  static const Color bottom_nav_bg = Color(0xff1A1B20);
  static const Color nav_fixed_color = Color(0xffFF324D);
}
